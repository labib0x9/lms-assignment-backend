...
For Role Creation (Student, Instructor, Content Manager, Admin):

- goto `http://localhost:1337/admin` -> 

For Instructor, Content Manager, Admin signup:

- goto `http://localhost:1337/admin` -> content-manager -> User -> Find the user and edit -> set blocked = false
